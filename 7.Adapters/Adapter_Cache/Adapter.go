...
// * the given interface (in form of lines)

// * the interface we have (int terms of points)
...
/*
! Problem :
! The only way to create rectangle is by making a VectorImage
! And, the only to print image is by providing a RasterImage
! Need an adapter that takes a vectorImage and provides RasterImage
*/
// ? Solution
